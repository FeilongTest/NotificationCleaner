package com.lywl.cleaner.utils;
...
import com.lywl.cleaner.NotificationListener;
import com.lywl.cleaner.R;
...
//                        gotoSet(context);//打开手机设置页面
    ...
    public static void cancelNotification(Context context, boolean isCancelAll) {
        Intent intent = new Intent();
        intent.setAction(NotificationListener.ACTION_NLS_CONTROL);
        if (isCancelAll) {
